/**
 * Kaleidoscope - Mirrored wedge effect.
 *
 * Image is divided into mirrored segments radiating from the cursor.
 * Segment count increases with hover. Creates mandala-like patterns.
 */
...
export class Kaleidoscope extends ImageEffect {
  setupMaterial() {
